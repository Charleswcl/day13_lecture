package sg.edu.iss.day13_lecture.model;
...
public class Employee {
    ...
    @Size(min = 1, max=100, message = "Last Name muxt be between 1 to 100 characters")
    ...
    @Max(value = 400000, message = "Max salary is 400000.")
